...
def childrens_catalog(request):
    ...
    },
    {
        ...
        { "uz": "ogiz", "ru": "УХОД ЗА ПОЛОСТЬЮ РТА И НОСА",'data':[ 
    {
        "id": 12,
    ...
    },
    {
        ...
        {"uz": "tomog", "ru": "ИММУНИТЕТ И БОЛЕЗНИ",
        "data":[  {
        "id": 15,
        "name": "Для десен (дт)"
    },
  ...
  , },
    ...
    },
    {
        ...
        ], "uz": "tomog pasti", "ru": "ОБЩЕЕ РАЗВИТИЕ"},
        {"data":[
            {
        "id": 22,
    ...
    },
    {
        ...
        {"uz": "kulok", "ru": "ЗАБОЛЕВАНИЯ УШЕЙ","data": [ {
        "id": 24,
        "name": "Ушные инфекции (дт)"
    }]},

        {"uz": "oshkozON", "ru": "ПИЩЕВАРЕНИЕ","data":[
            {
        "id": 25,
    ...
    },
    {
        ...
        { "uz": "oshkozON pasti", "ru": "ПРОЧЕЕ","data":[  {
        "id": 28,
        "name": "Подгузники (дт)"
    },
    {
...
@api_view(['GET'])
def adults_catalog(request):
    data = [
    {"uz": "miya", "ru": "НЕВРОЛОГИЯ","data":
    [
            {
        "id": 30,
        "name": "Бессонница"
    ...
    {"uz": "soch", "ru": "УХОД ЗА ВОЛОСАМИ","data":[
    ...
    { "uz": "yuz", "ru": "СРЕДСТВА ДЛЯ УХОДА ЗА КОЖЕЙ ЛИЦА","data":[
    ...
    { "uz": "tomog", "ru": "ПРОСТУДНЫЕ ЗАБОЛЕВАНИЯ И ИММУНИТЕТ","data":[
          {
        "id": 51,
        "name": "Ангина"
    },
    ...
    { "uz": "upka", "ru": "ЛЕЧЕНИЕ ДЫХАТЕЛЬНОЙ СИСТЕМЫ","data":[
            {
        "id": 54,
    ...
    { "uz": "jigar", "ru": "ЗАБОЛЕВАНИЯ ПЕЧЕНИ",'data':[
    ...
    { "uz": "buyrak", "ru": "ПОЧКИ И МОЧЕВЫДЕЛИТЕЛЬНАЯ СИСТЕМА",'data':[
            {
        "id": 65,
    ...
    { "uz": "reproduktiv/jinsiy tizim", "ru": "РЕПРОДУКТИВНАЯ СИСТЕМА",'data':[
            {
        "id": 69,
        "name": "Бесплодие"
    },
    ...
    { "uz": "burun", "ru": "УХОД ЗА ПОЛОСТЬЮ НОСА","data":[
    {
        "id": 87,
    ...
    { "uz": "ogiz", "ru": "ГИГИЕНА ПОЛОСТИ РТА И УХОД ЗА ГУБАМИ","data":[
    ...
    { "uz": "yurak", "ru": "СЕРДЕЧНО-СОСУДИСТАЯ СИСТЕМА","data":[
    ...
    { "uz": "ichaklar", "ru": "ЗАБОЛЕВАНИЯ КИШЕЧНИКА","data":[
    ...
    { "uz": "yurak teparogi", "ru": "ОСАНКА","data":[
    ...
    {"uz": "ichaklar teparogi/bel", "ru": "МЕДИЦИНСКИЕ ПОЯСА",'data':[
    ...
    {"uz": "ichaklar pastrigi/gemmoroy", "ru": "АНТИГЕМОРРОИДАЛЬНЫЕ СРЕДСТВА",'data':[
    ...
    {"uz": "buzoklar/oyoq tomirlari", "ru": "ЗАБОЛЕВАНИЯ ВЕН","data":
    [
    ...
    { "uz": "ikkinchi oyoq tugmachasi", "ru": "ПЛАСТЫРИ",
    "data":[
    ...
    { "uz": "kul tomiri", "ru": "ЗАБОЛЕВАНИЯ КРОВИ","data":[
    ...
    {"uz": "kul/tirnoq", "ru": "УХОД ЗА РУКАМИ",'data':[
    ...
    { "uz": "tizza", "ru": "ЗАБОЛЕВАНИЯ КОСТЕЙ И СУСТАВОВ","data":[
    ...
    { "uz": "oyoq eng pastdagi tugmachasi", "ru": "УХОД И СРЕДСТВА ДЛЯ НОГ",'data':[
